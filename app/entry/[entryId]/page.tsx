...
import { AdminEntryConfirmationPanel } from "@/app/entry/[entryId]/admin-entry-confirmation-panel";
    ...
    <main className="min-h-screen bg-[#f8f4ec] text-[#18211f]">
      ...
      <div className="px-6 py-10 sm:px-10">
        <div className="mx-auto max-w-4xl">
            ...
            <div className="grid gap-6 p-6 lg:grid-cols-[1fr_0.9fr]">
              <div>
                ...
                <p className="mt-3 text-base leading-7 text-[#59655f]">
                  Keep this screen available while you enter the simulator event
          ...
          {isAdmin && loggedEntry ? (
            <AdminEntryConfirmationPanel initialEntry={loggedEntry} />
          ) : null}
        </div>
      </div>
    </main>
