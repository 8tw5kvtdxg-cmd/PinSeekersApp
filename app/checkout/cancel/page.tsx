  ...
  return (
    <main className="min-h-screen bg-[#f8f4ec] px-6 py-10 text-[#18211f] sm:px-10">
      <div className="mx-auto max-w-xl rounded-lg border border-[#ded6c8] bg-white p-6 shadow-xl shadow-[#18211f]/8">
        ...
        <h1 className="mt-4 text-3xl font-black">Checkout is disabled</h1>
        <p className="mt-4 leading-7 text-[#59655f]">
          Pin2Win no longer processes customer checkout. Book through Alamo Golf
          Den, then return to Play Now onsite and confirm the matched booking.
        </p>
        <Link
          href="/play"
