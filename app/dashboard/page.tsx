    ...
    <main className="min-h-screen bg-[#f8f4ec] px-6 py-10 text-[#18211f] sm:px-10">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-10 grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
          <section>
            <ClipboardList className="text-[#2f6b3f]" size={34} />
          ...
          <section className="rounded-lg border border-[#ded6c8] bg-white p-6">
            <div className="flex items-center gap-3">
              <Flag className="text-[#2f6b3f]" size={28} />
            ...
            <div className="mt-5 space-y-3">
              {queue.map((item) => (
                ...
                >
                  ...
                  <span className="text-sm font-black text-[#2f6b3f]">{item.status}</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="rounded-lg bg-[#18211f] p-6 text-white lg:col-span-2">
            <div className="flex items-center gap-3">
              <PencilLine className="text-[#a8c878]" size={28} />
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-4">
              {["Entry", "Shot distance", "Pin distance", "Final score"].map((label) => (
                <label key={label} className="grid gap-2 text-sm font-bold text-white/70">
                  {label}
                  <input className="h-12 rounded-md border border-white/16 bg-white/10 px-4 text-base text-white outline-none focus:border-[#2f6b3f]" />
                </label>
              ))}
            </div>
